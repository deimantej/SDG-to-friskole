...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/aos.css">
    ...
    <section id="nav-bar">
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="d-flex w-100 order-0">
                        ...
                        <a class="navbar-brand w-100 text-center" href="index.html"><img src="<?php echo get_template_directory_uri(); ?>./images/logo_black.png" alt=""></a>
                        <span class="w-100"></span>
                    </div>
                    <div class="right collapse navbar-collapse w-100 order-1 order-lg-0" id="navbarNav">
                            <ul class="navbar-nav rightLi">
                                <li class="nav-item">
    ...
    <section class="hero">
        ...
        <div class="container text-align">
            ...
            <div data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="2000">
                <a href="#hero2"><button class="learn">LEARN MORE</button></a>
              </div>
                ...
                <div class="row">
                    ...
                    <div data-aos="zoom-in-down" class="col-md-6">
                        <div class="profile-img">
                            <img src="<?php echo get_template_directory_uri(); ?>/home3.jfif" alt="">
                        </div>
                    </div>
                </div>
            </div>
...
<section>
    ...
    <footer class="page-footer font-small blue pt-4">
        ...
        <!-- Copyright -->
        <div class="footer-copyright text-center py-3">© 2019 Copyright: Mejls-Orten-Tinghøj Friskole 
        </div>
        <!-- Copyright -->
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js" integrity="sha384-JjSmVgyd0p3pXB1rRibZUAYoIIy6OrQ6VrjIEaFf/nJGzIxFDsf4x0xIM+B07jRM" crossorigin="anonymous"></script>
    ...
    <script src="<?php echo get_template_directory_uri(); ?>/aos.js"></script>
